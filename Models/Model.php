...
class Model extends Db {
    ...
    // ensuite on peut créer une méthode qui va prendre comme paramètre MOdel qu'on appel $model peu importe
    ...
    // ----------------UPDATE------------------
    // LE update est très proche du create, il nous faut d'abord entier avec un id car je dois mettre à jour à partir d'un id
